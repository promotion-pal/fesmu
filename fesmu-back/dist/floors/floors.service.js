...
let FloorsService = class FloorsService {
    ...
    async findOneWithConditions(conditions) {
        console.log(conditions);
        const floor = await this.floorRepository.findOne({ where: conditions });
        console.log(floor);
        if (!floor)
            throw new common_1.NotFoundException('Не найден этаж');
        return floor;
    }
...
exports.FloorsService = FloorsService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(floor_entity_1.FloorEntity)),
